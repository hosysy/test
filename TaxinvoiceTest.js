...
popbill.config({
  LinkID :'NURIGO',
  SecretKey : 'j6AhYTRnl5AWrCFVX1gnNkjPlZ5d+v0mP4wYBXPukI0=',
  IsTest : true,
...
/*
taxinvoiceService.registIssue('2183821r9r', Taxinvoice, false, false, "메모", "", "", "testkorea",
  function(response){
    console.log(response);
  },
  function(error){
...
taxinvoiceService.register('283281u1', Taxinvoice,
  function(response){
    console.log(response)
  },
  function(error){
